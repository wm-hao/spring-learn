...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/db1?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","root1234")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("app")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
